...
/// serialized payload for deferred validation, so the default convenience path includes one extra
/// payload-sized allowance on top of the helper-allocation headroom.
